...
1. Создали фккаунт на Github.com
2. Создать локальный репозиторий
3. "Подружить" ваш локальный и удаленный репозиторий. Github при создании нового 
...
5. Првести изменения "с другого компьютера".
